...
require (
	...
	github.com/appbaseio-confidential/arc-noss v0.0.0-20220907161609-96a6b543416a // indirect
	github.com/appbaseio/reactivesearch-api v0.0.0-20220907161426-def91a199d58 // indirect
