...
require (
	...
	github.com/appbaseio-confidential/arc-noss v0.0.0-20220901125906-b32566029a8a // indirect
	github.com/appbaseio/reactivesearch-api v0.0.0-20220830171218-19c727a4b31f // indirect
